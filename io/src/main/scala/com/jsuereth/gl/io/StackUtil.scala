...
inline def withMemoryStack[A](f: MemoryStack ?=> A): A = {
...
inline def withByteBuffer[A](size: Int)(f: ByteBuffer => A)(using stack: MemoryStack): A = 
...
inline def withFloatBuffer[A](size: Int)(f: FloatBuffer => A)(using stack: MemoryStack): A = 
...
inline def withIntBuffer[A](size: Int)(f: IntBuffer => A)(using stack: MemoryStack): A = 
